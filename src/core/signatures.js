...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    define('pdfjs/core/signatures', ['exports', 'pdfjs/shared/util',
      'pdfjs/core/primitives'],
      factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('../shared/util.js'), require('./primitives.js'));
  } else {
    factory((root.pdfjsCoreSignatures = {}), root.pdfjsSharedUtil,
...
var SignatureVerifierPromise = (function SignatureVerifierPromiseClosure() {
  ...
  SignatureVerifierPromise.prototype = {
    ...
    loadPkiJs: function SignatureVerifierPromise_loadPkiJs() {
      ...
      importScripts('../../node_modules/pkijs/org/pkijs/common.js',
                    '../../node_modules/asn1js/org/pkijs/asn1.js',
                    '../../node_modules/pkijs/org/pkijs/x509_schema.js',
                    '../../node_modules/pkijs/org/pkijs/x509_simpl.js',
                    '../../node_modules/pkijs/org/pkijs/cms_schema.js',
                    '../../node_modules/pkijs/org/pkijs/cms_simpl.js');
    },
...
exports.SignatureVerifierPromise = SignatureVerifierPromise;
}));
